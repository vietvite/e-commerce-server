    ...
    CommandLineRunner initRole(RoleRepository roleRepository) {
        return (args) -> {
            roleRepository.saveAll(
                    List.of(new Role("1", "ROLE_CUSTOMER"), new Role("2", "ROLE_SELLER"), new Role("3", "ROLE_ADMIN")));
        };
    }
    ...
    CommandLineRunner initCategory(CategoryRepository categoryRepository) {
        return (args) -> {
            ...
            categoryRepository.saveAll(
                    List.of(new Category("Thiết bị thông minh"), new Category("Sách"), new Category("Điện thoại"),
                            new Category("Máy tính"), new Category("Thời trang"), new Category("Phụ kiện thời trang"),
    ...
    CommandLineRunner initProducts(ProductRepository productRepository, CategoryRepository categoryRepository) {
        return (args) -> {
            ...
            productRepository.saveAll(List.of(new Product(
                    ...
                    100, "/img/product/407c703670c083b0505b614ec81c94ee.jpg", smartDigital, seller1, new ReviewStar(),
                    new Date(), new Date()),
                    ...
                    new Product("Vòng đeo tay thông minh Mi Band 4", (long) 850000,
                            ...
                            200, "/img/product/mi-band-4-6-600x600.jpg", smartDigital, seller1, new ReviewStar(),
                            new Date(), new Date()),

                    new Product("Ổ cắm hẹn giờ AL06", (long) 265000,
                            "Ổ cắm hẹn giờ tự động AL-06 là thiết bị điện tử giúp kiểm soát việc bật tắt dòng điện chạy qua thiết bị thứ 2 theo lịch trình, giúp bảo vệ thiết bị điện chạy trên nó một cách an toàn và hiệu quả. Al-06 được ứng dụng và sử dụng vào thực tế ở hầu hết các mô hình nhà thông minh hiện đại, điểm đặc biệt của sản phẩm đó là tính thực tiễn cao giúp người tiêu dùng có thể mua và sử dụng thiết bị ở bất cứ vị trí nào mình mong muốn. Tính năng chính của sản phẩm cũng chính là tên gọi của nó, điểm hay và đặc biệt nhất của thiết bị này đó là khả năng hoạt động bền bỉ và có độ bền cao cùng với tính năng bật tắt hẹn giờ lên lịch trình theo tuần. Nếu chẳng may nhà bạn có bị mất điện khi có điện trở lại tất cả các thông số đã cài đặt trước trên ổ cắm vẫn được lưu và tiếp tục hoạt động bình thường.",
                            34, "/img/product/twe052-600x600.jpg", smartDigital, seller1, new ReviewStar(), new Date(),
                            new Date()),

                    new Product("Loa thông minh Google Nest Mini (Thế hệ 2)", (long) 1100000,
                            "Khả năng nhận diện giọng nói Tiếng Việt của Google Nest Mini cũng tốt hơn rất nhiều so với Google Home Mini nhờ được trang bị hệ thống 3 micro (Google Home Mini chỉ có 2 micro). Bên cạnh đó, thiết bị còn được tích hợp sẵn một chip AI chuyên dụng để tương tác với người dùng tốt hơn. Về mặt thiết kế, thay đổi đáng chú ý nhất của Google Nest Mini là cổng cấp nguồn đã được thiết kế dạng hình tròn, trong khi đó phiên bản cũ có cổng cấp nguồn dạng dẹp. Cũng giống như phiên bản cũ, loa Google Nest Mini sẽ giúp bạn thỏa sức giải trí, nghe nhạc, hỏi về các thông tin ở mọi lĩnh vực hoặc ra lệnh để điều khiển các thiết bị trong ngôi nhà thông minh. Loa thông minh Google Nest Mini có 4 màu sắc để bạn lựa chọn. Sản phẩm được thiết kế rất đẹp và sang trọng, mặt trên được tích hợp 4 đèn Led hiển thị trạng thái hoạt động và âm lượng.",
                            34, "/img/product/loa-thong-minh-google-nest-mini-v2-abaro1-350x350.jpg", smartDigital,
                    ...
                    new Product("Vòng đeo tay thông minh Mi Band 3", (long) 550000,
                            ...
                            20, "/img/product/mi-band-3-nt-600x600.jpg", smartDigital, seller1, new ReviewStar(),
                            new Date(), new Date()),
                    ...
                    new Product("Bố Già (Mario Puzo)", (long) 66000,
                            ...
                            100, "/img/product/7eca66c10e5f99f14325733bf53aa425.jpg", book, seller1, new ReviewStar(),
                            new Date(), new Date()),
                    ...
                    new Product("Đất Máu Sicily (Mario Puzo)", (long) 72000,
                            ...
                            100, "/img/product/dat mau - bia 1.u335.d20160701.t101955.jpg", book, seller1,
                    ...
                    new Product("Không Gia Đình (Tái Bản)", (long) 65000,
                            ...
                            100, "/img/product/khong-gia-dinh---pc-bia-mem.u5552.d20171101.t141222.773750.jpg", book,
                            seller1, new ReviewStar(), new Date(), new Date()),
                    ...
                    new Product("Những Người Khốn Khổ (Trọn Bộ 5 Tập)", (long) 240000,
                            ...
                            100, "/img/product/433cf186367f485d62bd4d80379fc9fd.jpg", book, seller1, new ReviewStar(),
                            new Date(), new Date()),
                    ...
                    new Product("Hai Số Phận (Bìa Cứng)", (long) 440000,
                            ...
                            100, "/img/product/202015881b04b7c8a4b47d15cf9c049f.jpg", book, seller1, new ReviewStar(),
                            new Date(), new Date()),
                    ...
                    new Product("Tuổi Thơ Dữ Dội (Bản Mới 2013)", (long) 85000,
                            ...
                            100, "/img/product/tuoi-tho-du-doi-a.jpg", book, seller1, new ReviewStar(), new Date(),
                            new Date()),
                    ...
                    new Product("Hộp Sách: Tây Du Ký (Tái Bản 2018)", (long) 260000,
                            ...
                            100, "/img/product/5432cf841314cf28c9d5cde258955cb5.jpg", book, seller1, new ReviewStar(),
                            new Date(), new Date()),
                    ...
                    new Product("chienbinhcauvong", (long) 65000,
                            ...
                            100, "/img/product/chien_binh_cau_vong_sap_xuat_ban-240412_2.jpg", book, seller1,
                            new ReviewStar(), new Date(), new Date()),

                    new Product("Điện thoại Xiaomi Redmi Note 8 (4GB/64GB)", (long) 4390000,
                            "Một tác phẩm có tầm ảnh hưởng sâu rộng nhất Indonesia. “Thầy Harfan và cô Mus nghèo khổ đã mang đến cho tôi tuổi thơ đẹp nhất, tình bạn đẹp nhất, và tâm hồn phong phú, một thứ gì đó vô giá, thậm chí còn có giá trị hơn những khao khát mơ ước. Có thể tôi lầm, nhưng theo ý tôi, đây thật sự là hơi thở của giáo dục và linh hồn của một chốn được gọi là trường học.” - (Trích tác phẩm)",
                            100, "/img/product/202004160915267461.jpg", phone, seller1, new ReviewStar(), new Date(),
                            new Date()),
                    ...
                    new Product("Apple iPhone SE - 64GB - 2020 Chính hãng VN/A", (long) 10990000,
                            ...
                            19, "/img/product/201910021048421691.jpg", phone, seller1, new ReviewStar(), new Date(),
                            new Date()),
                    ...
                    new Product("Samsung Galaxy Note 10 Plus - Chính hãng", (long) 2290000,
                            ...
                            19, "/img/product/samsung-galaxy-note-10-silver-400x460.png", phone, seller1,
                            new ReviewStar(), new Date(), new Date()),
                    ...
                    new Product("Nokia 7.2 - Chính hãng", (long) 3790000,
                            ...
                            19, "/img/product/nokia-72-black-400x460.png", phone, seller1, new ReviewStar(), new Date(),
                            new Date()),
                    ...
                    new Product("Vsmart Bee - Chính Hãng", (long) 990000,
                            ...
                            19, "/img/product/vsmart-bee-blue-400x460.png", phone, seller1, new ReviewStar(),
                            new Date(), new Date()),
                    ...
                    new Product("Realme 5 Pro - R4GB/128GB - Chính hãng", (long) 4490000,
                            ...
                            55, "/img/product/realme-5-pro-8gb-purple-400x460.png", phone, seller1, new ReviewStar(),
                            new Date(), new Date()),
                    ...
                    new Product("Vsmart Joy 3 - 2GB/32GB - Chính Hãng", (long) 2290000,
                            ...
                            55, "/img/product/vsmart-joy-3-tim-400x460-400x460.png", phone, seller1, new ReviewStar(),
                            new Date(), new Date()),
                    ...
                    new Product("Samsung Galaxy A71 - Chính hãng", (long) 8250000,
                            ...
                            55, "/img/product/samsung-galaxy-a71-blue-400x460-400x460-1-400x460.png", phone, seller1,
                            new ReviewStar(), new Date(), new Date()),
                    ...
                    new Product("Điện thoại iPhone 8 Plus 64GB", (long) 14490000,
                            ...
                            55, "/img/product/iphone-8-plus-1-400x460.png", phone, seller1, new ReviewStar(),
                            new Date(), new Date()),

                    new Product("Điện thoại OPPO A9 (2020)", (long) 5990000,
                            "Kế thừa phiên bản OPPO A7 đã từng gây hot trước đó, OPPO A9 (2020) có nhiều sự cải tiến hơn về màn hình, camera và hiệu năng trải nghiệm. Cấu hình mạnh mẽ với chip mới Snapdragon 665, RAM 8 GB. Cung cấp sức mạnh cho chiếc smartphone là con chip tầm trung mới Snapdragon 665. So với phiên bản Snapdragon 660 trước đó, phiên bản chip này mang đến hiệu năng mạnh mẽ và tối ưu tiết kiệm điện hơn.",
                            55, "/img/product/oppo-a9-400x460-1-400x460.png", phone, seller1, new ReviewStar(),
                            new Date(), new Date()),

                    new Product("Điện thoại iPhone 11 Pro Max 256GB", (long) 37990000,
                            "Camera là một trong những điểm nâng cấp mạnh mẽ nhất năm nay Apple mang đến cho chiếc iPhone 11 Pro Max.Camera là một trong những điểm nâng cấp mạnh mẽ nhất năm nay Apple mang đến cho chiếc iPhone 11 Pro Max.Camera là một trong những điểm nâng cấp mạnh mẽ nhất năm nay Apple mang đến cho chiếc iPhone 11 Pro Max.Camera là một trong những điểm nâng cấp mạnh mẽ nhất năm nay Apple mang đến cho chiếc iPhone 11 Pro Max.",
                            55, "/img/product/iphone-11-pro-max-256gb-black-400x460.png", phone, seller1,
                            new ReviewStar(), new Date(), new Date()),
                            ...
                            55, "/img/product/samsung-galaxy-s20-ultra-400x460-1-400x460.png", phone, seller1,
                            new ReviewStar(), new Date(), new Date()),

                            new Product("Điện thoại huawei-p40-pro", (long) 23990000,
                            "siêu phẩm công nghệ hàng đầu mới ra mắt với nhiều đột phá công nghệ, màn hình tràn viền không khuyết điểm, hiệu năng đỉnh cao, camera độ phân giải siêu khủng 108 MP cùng khả năng zoom 100X thách thức mọi giới hạn smartphone.",
                            55, "/img/product/product-435x408-2.png", phone, seller1,
                            new ReviewStar(), new Date(), new Date()),

                            new Product("Điện thoại OPPO Find X2", (long) 23990000,
                            "Tiếp nối thành công vang dội của thế hệ Find X, OPPO chính thức ra mắt Find X2 với những đường nét thanh lịch từ thiết kế phần cứng cho đến trải nghiệm phần mềm, hứa hẹn một vẻ đẹp hoàn hảo, một sức mạnh xứng tầm. Trải nghiệm thị giác tuyệt vời Find X2 sở hữu màn hình AMOLED Ultra Vision cao cấp với kích thước lên đến 6.7 inch cùng độ phân giải 2K+ cực nét được bảo vệ bằng kính cường lực Corning Gorilla Glass 6 cao cấp.",
                            55, "/img/product/oppo-find-x2-xanh-400x460-1-400x460.png", phone, seller1,
                            new ReviewStar(), new Date(), new Date()),

                            new Product("Điện thoại Samsung Galaxy S10+", (long) 19990000,
                            "Samsung Galaxy S10+ 128GB là một trong những chiếc smartphone được trông chờ nhiều nhất trong năm 2019 và không phụ sự kỳ vọng của mọi người thì chiếc Galaxy S thứ 10 của Samsung thực sự gây ấn tượng mạnh cho người dùng.",
                            55, "/img/product/samsung-galaxy-s10-plus-white-400x460.png", phone, seller1,
                            new ReviewStar(), new Date(), new Date()),
                            ...
                            55, "/img/product/samsung-galaxy-z-flip-chitiet-2-788x544.png", phone, seller1,
                            new ReviewStar(), new Date(), new Date())
